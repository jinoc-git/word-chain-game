...
export type OpenAIResponse = { success: true; word: string } | { success: false; word: undefined };
...
export const POST = async (req: Request) => {
  try {
    ...
    return NextResponse.json({ success: true, word: nextWord });
  } catch (error) {
    return NextResponse.json({ success: false, word: undefined });
  }
};
